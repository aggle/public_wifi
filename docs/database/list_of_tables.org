...
Data
*** Description
This table is an analogue of the star_master table, but for candidates. It contains the name of the primary star, and maybe the average positions and magnitudes
